...
## Using Pre-Compiled Protobuf Messages in Official Python Package
...
There is also another way to get to use already compiled `.proto` files which
exist in the
[official Python package](https://pypi.org/project/ctrader_open_api/). Since
...
When you have an older runtime like here, it can't load `.proto` files compiled
